...
import { baseSepolia, lineaSepolia } from "thirdweb/chains";
...
const CreateCampaignModal = (
    ...
    const handleDeployContract = async () => {
        ...
        try {
            ...
            console.log({campaignName, campaignDescription, campaignGoal, campaignDeadline});
            const contractAddress = await deployPublishedContract({
                ...
                publisher: "0xbfFa1DBE027AaD3F1e955C6BF03AcDb26303C05F",
                version: "1.0.1",
            });
